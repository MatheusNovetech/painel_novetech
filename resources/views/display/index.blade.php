    ...
    <div id="callarea" class="row" style="line-height:1.23">
        ...
        <div class="col m8">
            <div class="card-panel center-align" style="margin-bottom:0; background-color: blue">
                <span style="font-size:45px; color: white">{{ trans('messages.display.token') }} {{ trans('messages.call.number') }}</span><br>
                <span id="num0" style="font-size:185px;color:white;font-weight:bold;line-height:1.5">{{ $data[0]['number'] }}</span><br>
                <span style="font-size:40px; color:white;">{{ trans('messages.display.please') }} {{ trans('messages.display.proceed_to') }}</span><br>
                    ...
                    if (curr!=s[0].call_id) {
                        ...
                        if (curr!=0) {
                            ...
                            window.setTimeout(function() {
                                ...
                                responsiveVoice.speak(msg1, "{{ $settings->language->display }}", {rate: 1.00});
                            }, 10);
                        }
                        curr = s[0].call_id;
                    }
