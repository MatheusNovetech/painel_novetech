...
<html>
    <head>
        ...
        <title>ACESSO | NOVETECH</title>
        <link rel="icon" href="<?php echo e(asset('assets/images/logo9.png')); ?>">
                ...
                <form class="login-form" action="<?php echo e(route('post_login')); ?>" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">Novetech</p>
                            <p class="center login-form-text" style="letter-spacing:1px">Insira sua credencial</p>
                        </div>
                    </div>
                    <div class="row margin">
                        <div class="input-field col s12">
                            ...
                            <label for="username" class="active">Nome Usuário</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m12 l12  login-text">
                            ...
                            <label for="remember-me">Gravar Credenciais</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                            <button type="submit" class="btn waves-effect waves-light col s12">Acesse</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            <p class="margin medium-small"><a href="<?php echo e(route('get_email')); ?>">Recuperar Senha ?</a></p>
                        </div>
                    </div>
                </form>
            </div>
            <div class="row center-align white-text" style="margin-bottom:0">
                <span>Powered by <a href="http://www.novetech.com.br" target="_blank" style="color:#ccc">Novetech Soluções Tecnológicas</a></span>
            </div>
        </div>
